...
public class PostTokens extends APIInvoker {
	 ...
	 * 
	 * @param req
	 *            リクエスト用のPostTokensRequestオブジェクト
	...
	public PostTokensResponse request(PostTokensRequest req)
		...
		String url = EndPoints.IdentityService + "/v2.0/tokens";
		...
		PostTokensResponse postTokensResponse = this.getObjectMapper().readValue(res_json, PostTokensResponse.class);
